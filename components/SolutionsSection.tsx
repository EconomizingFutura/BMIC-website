...
const solutions = [
  {
    ...
    description:
      "Complete engineering design, analysis, and project management solutions for complex industrial projects.",
    features: [
      "CAD Design",
      "Structural Analysis",
      "Project Management",
  ...
  },
  {
    ...
    description:
      "Industrial automation systems that improve efficiency, reduce costs, and enhance safety.",
    features: [
      "PLC Programming",
      "SCADA Systems",
      "Robotics",
  ...
  },
  {
    ...
    description:
      "Comprehensive safety solutions and regulatory compliance services for all industries.",
    features: [
      "Safety Audits",
      "Compliance Training",
      "Risk Assessment",
  ...
  },
  {
    ...
    description:
      "Worldwide procurement and supply chain management for industrial components and materials.",
    features: [
      "Global Sourcing",
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6">
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm">
              24/7 support and preventive maintenance programs
            </p>
          </Card>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-sm">
              Precision manufacturing for specialized components
            </p>
          </Card>
