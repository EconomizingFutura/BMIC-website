...
import { ArrowLeft, Filter, Thermometer, Snowflake, Wind, Building2 } from "lucide-react";
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our comprehensive portfolio of completed projects across 
              thermal insulation, cold storage, and HVAC ducting systems.
            </p>
          </div>
        </div>
      </section>
