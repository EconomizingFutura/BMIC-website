...
const caseStudies = [
  {
    ...
    challenge:
      "Modernize aging tablet production line while maintaining continuous operation",
    solution:
      "Phased implementation of automated tablet compression and coating systems",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Design and build GMP-compliant facility for cell therapy manufacturing",
    solution:
      "Complete turnkey clean room solution with advanced environmental controls",
    results: [
  ...
  },
  {
    ...
    challenge:
      "Implement comprehensive quality management system for regulatory compliance",
    ...
    image:
      "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    duration: "24 months",
    investment: "$12M",
    roi: "300% in 4 years",
  },
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-blue-50 via-white to-accent/20 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div
            className="absolute bottom-1/4 right-1/3 w-8 h-8 border border-blue-500/40 rounded-lg rotate-45 animate-spin"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                ...
                manufacturing, ensuring compliance, quality, and efficiency in
                every aspect of drug production from R&D to commercial scale
                manufacturing.
              </p>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <Badge
                  variant="outline"
                  className="px-4 py-2 border-blue-300 text-blue-700"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                {pharmaStats.slice(0, 2).map((stat, index) => (
                  <Card
                    key={index}
                    className="text-center p-4 bg-white/80 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-shadow"
                  >
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl text-gray-900 mb-4">
              Overcoming{" "}
              <span className="text-red-600">Critical Challenges</span> in
              Pharma
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div
            className="absolute top-1/4 left-1/4 w-32 h-32 border border-blue-500 rounded-lg rotate-12 animate-spin"
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl text-gray-900 mb-4">
              Specialized <span className="text-blue-600">Products</span> for
              Pharma
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl text-gray-900 mb-4">
              Proven <span className="text-green-600">Results</span> in
              Pharmaceutical Projects
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Real-world examples of how our solutions have transformed
              pharmaceutical manufacturing operations and delivered measurable
              results.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl text-gray-900 mb-4">
                ...
                <span className="text-primary">Pharmaceutical Operations?</span>
              </h2>
              <p className="text-lg text-gray-600">
                Contact our pharmaceutical experts for a customized consultation
                and solution design.
              </p>
            </div>
