...
import { Target, Eye, Users, Building, Award, Linkedin, Twitter, Mail, ArrowLeft, Zap, Globe, TrendingUp, Shield } from "lucide-react";
...
const teamMembers = [
  ...
  },
  {
    ...
    experience: "20+ years",
    image: "https://images.unsplash.com/photo-1494790108755-2616b612b5c1?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&q=80",
...
const infrastructureImages = [
  {
    ...
    description: "State-of-the-art 100,000 sq ft manufacturing facility with advanced automation"
  },
  {
    ...
    description: "Cutting-edge R&D laboratory for innovation and product testing"
  },
  {
  ...
  },
  {
    ...
    description: "Modern warehouse with automated logistics and inventory systems"
  }
];

const partnerBrands = [
  { name: "Siemens", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Siemens" },
  { name: "General Electric", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=GE" },
  { name: "ABB", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=ABB" },
  { name: "Schneider Electric", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Schneider" },
  { name: "Rockwell Automation", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Rockwell" },
  { name: "Honeywell", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Honeywell" },
  { name: "Emerson", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Emerson" },
  { name: "Mitsubishi", logo: "https://via.placeholder.com/150x80/005919/FFFFFF?text=Mitsubishi" }
];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-primary/5 via-white to-accent/20 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-1/3 right-1/4 w-8 h-8 border border-primary/30 rounded-lg rotate-45 animate-spin" style={{ animationDuration: '8s' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-6xl text-gray-900 mb-6">
                Building the <span className="text-primary relative">
                  Future
                  <div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-primary to-accent rounded-full"></div>
                </span> of Industry
              </h1>
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                For over three decades, we've been at the forefront of industrial innovation, 
                delivering cutting-edge solutions that transform businesses and shape the future 
                of manufacturing and engineering excellence.
              </p>
              
              {/* Achievement Highlights */}
              <div className="grid grid-cols-2 gap-4 mt-8">
                {achievements.slice(0, 2).map((achievement, index) => (
                  <Card key={index} className="text-center p-4 bg-white/80 backdrop-blur-sm border-primary/20 hover:shadow-lg transition-shadow">
                    <div className="text-primary mb-2 flex justify-center">{achievement.icon}</div>
                    <div className="text-2xl text-primary mb-1">{achievement.number}</div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Founded in 1994, our company began as a small engineering consultancy with a bold vision: 
                  to revolutionize industrial processes through innovative technology and unwavering commitment 
                  to excellence. Today, we stand as a global leader in industrial solutions.
                </p>
                <p className="text-gray-600 leading-relaxed mb-6">
                  Our journey has been marked by continuous growth, strategic partnerships, and breakthrough 
                  innovations that have set new industry standards. We've successfully completed over 500 
                  projects across six continents, serving clients from startups to Fortune 500 companies.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  { year: "1994", label: "Company Founded", icon: <Building className="h-5 w-5" /> },
                  { year: "500+", label: "Projects Completed", icon: <Target className="h-5 w-5" /> },
                  { year: "50+", label: "Countries Served", icon: <Globe className="h-5 w-5" /> },
                  { year: "200+", label: "Team Members", icon: <Users className="h-5 w-5" /> }
                ].map((stat, index) => (
                  <Card key={index} className="text-center p-6 bg-gradient-to-br from-primary/5 to-accent/20 border-primary/20 hover:shadow-xl hover:scale-105 transition-all duration-300">
                    <div className="flex justify-center mb-3 text-primary">{stat.icon}</div>
                    <div className="text-2xl text-primary mb-2">{stat.year}</div>
            ...
            <div className="relative">
              <div className="relative z-10">
                ...
                <Card className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-sm p-4 shadow-xl">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="text-primary">ISO 9001:2015 Certified</div>
                      <div className="text-sm text-gray-600">Quality Management Excellence</div>
                    </div>
                  </div>
                </Card>
              </div>
              ...
              <div className="absolute top-1/4 -left-6 w-12 h-12 border-2 border-primary/30 rounded-lg rotate-45 animate-spin" style={{ animationDuration: '6s' }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-accent/30 to-primary/5 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-10 right-1/4 w-32 h-32 bg-primary/20 rounded-lg rotate-45 animate-bounce" style={{ animationDuration: '3s' }} />
          <div className="absolute top-1/3 left-1/2 w-6 h-6 bg-primary rounded-full animate-ping" />
          <div className="absolute bottom-1/3 left-1/5 w-20 h-20 border-2 border-primary/20 rounded-full animate-spin" style={{ animationDuration: '10s' }} />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Driving forward with purpose and clear direction toward a sustainable industrial future.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="relative overflow-hidden hover:shadow-xl transition-all duration-300 group">
              ...
              <CardContent className="p-8 relative">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  To deliver innovative engineering solutions that enhance operational efficiency, 
                  ensure safety, and drive sustainable growth for our clients across all industries.
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-gradient-to-r from-primary to-accent rounded-full" />
                    <span className="text-gray-700">Client success as our priority</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-gradient-to-r from-primary to-accent rounded-full" />
            ...
            <Card className="relative overflow-hidden hover:shadow-xl transition-all duration-300 group">
              ...
              <CardContent className="p-8 relative">
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  ...
                  technology integration, environmental responsibility, and operational excellence.
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-gradient-to-r from-accent to-primary rounded-full" />
                    <span className="text-gray-700">Global industry leadership</span>
                  </li>
                  <li className="flex items-center space-x-3">
                    <div className="w-3 h-3 bg-gradient-to-r from-accent to-primary rounded-full" />
          ...
          <div className="mt-16 grid md:grid-cols-4 gap-6">
            {achievements.map((achievement, index) => (
              <Card key={index} className="text-center p-6 bg-white/80 backdrop-blur-sm hover:shadow-xl hover:scale-105 transition-all duration-300">
                ...
                <div className="text-2xl text-primary mb-2">{achievement.number}</div>
                <div className="text-sm text-gray-900 mb-2">{achievement.label}</div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-8 gap-8 h-full">
            {Array.from({ length: 64 }).map((_, i) => (
              <div key={i} className="h-full">
                {i % 3 === 0 && <div className="w-2 h-2 bg-primary rounded-full animate-pulse" style={{ animationDelay: `${i * 100}ms` }} />}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Meet the experienced professionals who guide our company's vision and drive our success.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-accent/20 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-1/4 left-10 w-32 h-32 border-2 border-primary rounded-lg rotate-12 animate-spin" style={{ animationDuration: '15s' }} />
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl text-gray-900 mb-4">
              Our <span className="text-primary">Infrastructure</span> & Facilities
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              State-of-the-art facilities equipped with the latest technology to deliver exceptional results.
            </p>
          </div>
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex flex-col justify-between p-6 text-white">
                    ...
                    <div>
                      ...
                      <p className="text-sm opacity-90 mb-4">{facility.description}</p>
          ...
          <div className="mt-16 bg-white rounded-3xl p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-4 gap-8 text-center">
              {[
                { icon: <Building className="h-8 w-8" />, number: "100,000", label: "sq ft Manufacturing Space", color: "from-blue-500 to-primary" },
                { icon: <Users className="h-8 w-8" />, number: "200+", label: "Skilled Professionals", color: "from-green-500 to-primary" },
                { icon: <Award className="h-8 w-8" />, number: "15+", label: "ISO Certifications", color: "from-purple-500 to-primary" },
                { icon: <Target className="h-8 w-8" />, number: "24/7", label: "Operations Support", color: "from-orange-500 to-primary" }
              ].map((stat, index) => (
                <div key={index} className="space-y-4 group hover:scale-105 transition-transform duration-300">
                  <div className={`w-16 h-16 bg-gradient-to-r ${stat.color} rounded-full flex items-center justify-center mx-auto text-white group-hover:shadow-lg transition-shadow`}>
                    {stat.icon}
                  </div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We collaborate with industry-leading brands to deliver the highest quality solutions.
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {partnerBrands.map((partner, index) => (
              <Card key={index} className="p-4 hover:shadow-lg transition-all duration-300 bg-gray-50 hover:bg-white group relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <img
                  src={partner.logo}
                  alt={partner.name}
