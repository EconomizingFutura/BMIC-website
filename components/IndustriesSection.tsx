...
const industries = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1625180726018-580b17371d52?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80"
  },
  {
    icon: Shield,
    title: "Defense",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            that meet the unique challenges of each sector.
          </p>
        </div>
