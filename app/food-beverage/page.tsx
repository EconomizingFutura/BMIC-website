...
export default function FoodIndustryPage() {
  ...
  const projects = [
    {
      title: "Advanced FMCG  Manufacturing Plant",
  ...
  const cards = [
    ...
    },
    {
      ...
      applications: [
        "Food & beverage packaging halls",
        "FMCG product serialization areas",
        "Cold chain packaging & labeling zones",
        "Temperature-sensitive storage facilities",
      ],
      features: [
        "Food-grade hygienic insulation",
        "Easy-to-clean and moisture-resistant surfaces",
        "Precise temperature & humidity stability",
        "Energy-efficient performance",
      ],
      specs: {
        capacity: "25–100 mm (customized)",
        accuracy: "≤0.035 W/m·K",
        material: "PIR / PUF / Rockwool with aluminum or GI cladding",
        standards: "ISO 9001, HACCP, FSSAI compliance",
      },
    },
  ];
  ...
  const data = [
    {
      ...
      description:
        " Adhering to FSSAI, HACCP, and global food safety regulations while ensuring hygienic production and storage conditions.",
      solutions: [
        "Food-grade insulation materials",
        "Hygienic ducting systems",
    ...
    },
    {
      ...
      description:
        " Maintaining precise temperature and humidity levels for food processing, packaging, and cold storage facilities.",
      solutions: [
        "Thermal insulation for cold & hot processes",
    ...
    },
    {
      ...
      priorityColor: "bg-[#005919] text-white",
      description:
        "Prevent microbial growth, cross-contamination, ensuring product safety in production and storage.",
      solutions: [
        "Moisture-resistant insulation",
        "Airflow management & filtration support",
        "Hygienic cladding materials",
      ],
    },
    {
      ...
      description:
        " Balancing food safety with energy savings, production speed, and cost-effectiveness.",
      solutions: [
            ...
            <div className="space-y-8 max-w-[586px] w-full ">
              ...
              <div className="space-y-4">
                <h1 className="text-2xl sm:text-3xl md:text-4xl  font-semibold leading-tight text-gray-900">
                  Advancing
                  <span className="text-primary"> Food & FMCG</span>
                  <br /> Manufacturing
                </h1>
                <p className="text-base  text-gray-600 leading-relaxed ">
                  Delivering advanced insulation and ducting solutions for food
                  and FMCG facilities, ensuring hygiene, energy efficiency, and
                  regulatory compliance across production, packaging, and
                  storage environments. Our expertise supports
                  temperature-controlled operations, contamination prevention,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-5xl mx-auto">
              The food and FMCG sector demands strict hygiene, temperature
              control, and energy efficiency to ensure safety, quality, and
              compliance.
            </p>
          </div>
      ...
      <section className="py-16 bg-[#F9FAFB]">
        <div className="container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 max-w-5xl mx-auto">
              Comprehensive range of insulation and ducting systems designed for
              food and FMCG facilities, ensuring hygiene, energy efficiency, and
              regulatory compliance.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-semibold text-gray-900 mb-4">
              ...
              in Food & FMCG Projects
            </h2>
            <p className="text-lg text-gray-600 max-w-5xl  mx-auto">
              Real-world examples of how our insulation and ducting solutions
              have enhanced food and FMCG facilities, ensuring hygiene, energy
              efficiency, and compliance with global safety standards.
            </p>
          </div>
