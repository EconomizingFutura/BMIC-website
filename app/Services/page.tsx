...
import { ArrowLeft, Thermometer, Snowflake, Wind, Factory, Zap, Shield, Download, FileText, Phone, ArrowRight, CheckCircle } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "High-performance insulation solutions for industrial pipes, vessels, and equipment operating at extreme temperatures.",
    ...
    },
    {
      ...
      description: "Precision-controlled cold storage facilities for pharmaceuticals, food processing, and specialty applications.",
    ...
    },
    {
      ...
      description: "Complete HVAC solutions including design, installation, and maintenance of air conditioning and ventilation systems.",
    ...
    },
    {
      ...
      description: "Comprehensive industrial thermal management including steam systems, process heating, and equipment insulation.",
    ...
    },
    {
      ...
      description: "Energy audit, optimization consulting, and implementation of energy-saving thermal management solutions.",
    ...
    },
    {
      ...
      description: "Ensuring compliance with international standards, safety regulations, and industry-specific requirements.",
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl lg:text-6xl text-gray-900 mb-6">
              Comprehensive <span className="text-primary relative">
                Thermal Solutions
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto mb-8">
              From high-temperature industrial insulation to precision cold storage and 
              energy-efficient HVAC systems, we deliver cutting-edge thermal management 
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            {services.map((service) => (
              <Card key={service.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <CardContent className="p-6">
                  <div className="space-y-6">
                    {/* Key Features */}
                    <div>
                      <h4 className="text-lg text-gray-900 mb-3">Key Features</h4>
                    ...
                    {/* Applications */}
                    <div>
                      <h4 className="text-lg text-gray-900 mb-3">Applications</h4>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <h4 className="text-sm text-gray-900 mb-2">Technical Specifications</h4>
                      <div className="grid grid-cols-2 gap-2 text-xs">
                        <div>
                          <span className="text-gray-500">Materials:</span>
                          <p className="text-gray-700 truncate">{service.specifications.materials}</p>
                        </div>
                        <div>
                          <span className="text-gray-500">Certification:</span>
                          <p className="text-gray-700 truncate">{service.specifications.certification}</p>
                        </div>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              From initial consultation to post-installation maintenance, we provide 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-lg text-gray-900 mb-2">Consultation</h3>
              <p className="text-gray-600 text-sm">
                Expert consultation and technical assessment for your specific requirements.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-lg text-gray-900 mb-2">Maintenance</h3>
              <p className="text-gray-600 text-sm">
                Preventive maintenance and 24/7 support to ensure optimal performance.
              </p>
            </Card>
            ...
            <Card className="text-center p-6 hover:shadow-lg transition-shadow duration-300">
              ...
              <h3 className="text-lg text-gray-900 mb-2">Optimization</h3>
              <p className="text-gray-600 text-sm">
                Continuous monitoring and optimization for maximum energy efficiency.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-white/90">
              Let our experts design a custom solution that meets your specific requirements 
              and delivers exceptional performance and energy savings.
            </p>
